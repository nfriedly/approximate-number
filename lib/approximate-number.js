...
(function() {
  ...
  function formatDec(num, base, opts) {
    ...
    if (opts.precision) {
      num = parseFloat(parseFloat(workingNum).toPrecision(opts.precision));
    } else {
   ...
   * @param {Number} [opts.precision=3] Optional number of significant digits. Must be greater than 0.
   *
   * @returns {String}
   */
